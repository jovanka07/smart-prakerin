...
<div class="row" style="width: 100%;">
          <div class="col-lg-12">
            <h1><small style="margin-left: 20px">Halaman Proses</small></h1>
            <ol class="breadcrumb">
...
<div class="container">
  <table id="table_id" class="display">
    ...
    <tbody>
      ...
      //query
      $query = $conn->query("SELECT * FROM pengajuan a, perusahaan b, user c WHERE a.id_perusahaan=b.id_perusahaan AND a.id_user=c.id_user AND status_role='proses'");
      //while
      $i = 1;
      while($data = $query->fetch_array()){
        ?>
          <tr>
            ...
            <td> <a href="ubah-pengajuan.php?id=<?php echo $data['id_user']; ?> " class="btn btn-primary btn-sm" onclick="return confirm('Ingin Mengupdate?')">Update </a></td>
